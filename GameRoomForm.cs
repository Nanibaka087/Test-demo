...
namespace Task1._4
{
    ...
    {
        private const int CHESS_BOARD_WIDTH = 16;  // Số cột của bàn cờ
        private const int CHESS_BOARD_HEIGHT = 15; // Số hàng của bàn cờ
        private const int CHESS_WIDTH = 25;        // Chiều rộng của mỗi ô
        private const int CHESS_HEIGHT = 25;       // Chiều cao của mỗi ô
        public GameRoomForm()
        {
